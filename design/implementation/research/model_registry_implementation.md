# Model Registry Implementation Guide
...
## Purpose
Guide the frontend implementation of the Model Registry workspace using existing styles and assets.
...
## Files to Create
- `app/lab/models/page.tsx` (Main workspace view)
- `components/model_registry/` (Domain-specific layout items if not present in MQDS)
...
## Temporary Mock Data
- Shape should mirror output of API schema. Keep initial mock in `lib/mock-data/model_registry-mock.json`.
