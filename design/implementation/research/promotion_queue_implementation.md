# Promotion Queue Implementation Guide
...
## Purpose
Guide the frontend implementation of the Promotion Queue workspace using existing styles and assets.
...
## Files to Create
- `app/lab/promotion/page.tsx` (Main workspace view)
- `components/promotion_queue/` (Domain-specific layout items if not present in MQDS)
...
## Temporary Mock Data
- Shape should mirror output of API schema. Keep initial mock in `lib/mock-data/promotion_queue-mock.json`.
